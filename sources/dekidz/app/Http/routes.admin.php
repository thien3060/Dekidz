...
Route::group(['middleware' => config('admin.filter.auth')], function () {
    ...
    Route::post('study_results/update', 'StudyResultController@update')->name('admin.study_results.update');
    ...
    Route::get('standard_index', 'HealthStandardIndexsController@showStandardIndex')->name('admin.standard_index');
    ...
    Route::get('age_report', 'ReportsController@ageReport')->name('admin.age_report');
});
