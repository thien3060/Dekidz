                        ...
                        @if(isset($model))
                            @foreach($model->foods as $k => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control asset-price" onkeyup="updateCost(this);" onchange="updateCost(this);" placeholder="Food's price" name="asset-price[]" type="number" value="{{$item->pivot->price}}">
                                    </td>
                                    <td>
