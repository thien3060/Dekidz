            ...
            <div class="box-body text-center">
                <table class="table">
                    ...
                    @if(isset($model))
                        @foreach($model->foods as $food)
                            <tr>
                                ...
                                <td>
                                    <input class="form-control asset-status" placeholder="Asset's status" name="asset-status[]" type="text"  value="{{$food->pivot->status}}">
                                </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control asset-status" placeholder="Asset's status" name="asset-status[]" type="text" >
                        </td>
                        <td style="text-align: center">
                            <button type="button" class="btn btn-danger asset-delete" onclick="confirmDelete(this)"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                        </td>
