        ...
        <div class="vertical-center sun">
            <div class="container">
                <div class="row">
                    <div class="action">
                        <div class="col-sm-12">
                            <h1 class="title">Bảng học phí</h1>
                            <p>Chi tiết học phí cho từng khóa học</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="single-price price-one">
                        ...
                        {{--</ul>--}}
                        <a href="#" class="btn btn-buynow">ĐĂNG KÍ</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="single-price price-two">
                        <div class="table-heading">
                            <p class="plan-name">MẦM</p>
                            <p class="plan-price"><span class="dollar-sign">$</span><span class="price">89</span><span class="month">/ Tháng</span></p>
                        </div>
                        {{--<ul>--}}
                            {{--<li>Lorem ipsum dolor <span><i class="fa fa-check"></i></span></li>--}}
                            {{--<li>Consectetur adipiscing <span><i class="fa fa-times"></i></span></li>--}}
                            ...
                            {{--<li>Duis nec massa inter <span><i class="fa fa-check"></i></span></li>--}}
                        {{--</ul>--}}
                        <a href="#" class="btn btn-buynow btn-hightlight">ĐĂNG KÍ</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <div class="single-price price-three">
                        <div class="table-heading">
                            <p class="plan-name">CHỒI</p>
                            <p class="plan-price"><span class="dollar-sign">$</span><span class="price">29</span><span class="month">/ Tháng</span></p>
                        </div>
                        {{--<ul>--}}
                            {{--<li>Lorem ipsum dolor <span><i class="fa fa-check"></i></span></li>--}}
                            {{--<li>Consectetur adipiscing <span><i class="fa fa-times"></i></span></li>--}}
